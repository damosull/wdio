import practiceFormPage from "../../page-objects/demoqa/practice-form.page.js";
...
describe("Demo QA", () => {
  ...
  it("Fill out the form", async () => {
    ...
    await $("#uploadPicture").setValue(
      "C:/Pers/wdio/wdio/test/test-data/wdio-logo.png"
    ); // this file has to exist

    await $("#currentAddress").setValue("123 Main Street");

    await $("//input[@id='react-select-3-input']").setValue("NCR");
    // TODO: Being covered by footer, so commented out for now
    // await $("div=Select City").click();
