...
describe("Demo QA Text Box", () => {
  ...
  it("Fill out form & verify all info is printed on the screen", async () => {
  ...
  it.only("Check email field is highlighted when invalid email format is entered", async () => {
